...
def fetch_stats(selected_user, df):
    ...
    return num_messages, len(words), num_media_messages, links, len(links)
...
def heatmap(selected_user, df):
    ...
    user_hm = df.pivot_table(index='day_name', columns='period', values='message', aggfunc='count').fillna(0)
